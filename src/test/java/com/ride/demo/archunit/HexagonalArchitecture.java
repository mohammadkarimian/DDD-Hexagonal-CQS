...
public class HexagonalArchitecture extends ArchitectureElement {
    ...
    public HexagonalArchitecture withQueryLayer(String domainPackage) {
        this.queryLayer = new QueryLayer(fullQualifiedPackage(domainPackage), this);
        return this;
    }
    ...
    public void check(JavaClasses classes) {
        ...
        this.queryLayer.doesNotDependOn(this.applicationLayer.basePackage, classes);
